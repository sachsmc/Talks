...
- A geometric element that represents a data element can be tracked visually through the transition
...
```{r ggint, echo = TRUE, results = "asis", fig.width = 4, fig.height = 3, omit.js = TRUE}
library(gginteractive)
...
```{r gap1, echo = TRUE, results = "asis", fig.width = 4, fig.height = 3, omit.js = TRUE}
...
```{r test-km, fig.keep='none', results = 'asis', warning = FALSE, message = FALSE, echo = FALSE, fig.width=6, fig.height=4}
library(ggkm)
gdat <- survival::lung
